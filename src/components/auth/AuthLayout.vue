<template>
    <div class="flex h-screen">
        ...
        >
            <RouterLink class="btn-primary" to="/auth">Home</RouterLink>
            <RouterLink class="btn-primary" to="/auth/about">About</RouterLink>
            <div class="flex flex-row gap-2">
                <RouterLink class="btn-primary" to="/">Public</RouterLink>
        ...
        <div class="flex-initial w-screen">
            ...
            >
                Un truc cool à mettre ici (version auth)
            </header>
